...
from src.reports.views import ReportListView, ReportCreateView, ReportDetailView, ReportDeleteView
...
urlpatterns = [
    ...
    url(r'^delete/(?P<pk>\d+)$', login_required(ReportDeleteView.as_view()), name='delete'),
